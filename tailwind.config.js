  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'neon-gradient': 'linear-gradient(135deg, #ff00cc 0%, #333399 100%)',
        'matrix-pattern': 'radial-gradient(circle at 25% 25%, #00ff00 0%, transparent 50%), radial-gradient(circle at 75% 75%, #00ff00 0%, transparent 50%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'cyber': '0 0 20px rgba(34, 197, 94, 0.5)',
        'electric': '0 0 20px rgba(14, 165, 233, 0.5)',
      },
      backdropBlur: {
        xs: '2px',
      },
